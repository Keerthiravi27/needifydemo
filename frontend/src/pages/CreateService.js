  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white">
      ...
      <div className="page-container max-w-3xl mx-auto px-4 py-8">
        <Link to="/services">
          <Button variant="ghost" data-testid="back-to-services-btn" className="mb-6 rounded-full">
            <ArrowLeft className="w-4 h-4 mr-2" /> Back to Services
          </Button>
        </Link>

        <div className="bg-white rounded-3xl shadow-xl border border-green-100 p-8">
          <h1 className="text-3xl font-bold font-outfit text-primary-foreground mb-6" data-testid="create-service-heading">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <p className="text-sm text-muted-foreground">
                <strong>Note:</strong> A 15% platform commission will be applied to bookings of this service.
              </p>
            </div>
